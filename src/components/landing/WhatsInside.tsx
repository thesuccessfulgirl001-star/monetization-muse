...
const PARTS: { n: string; title: string; body: string }[] = [
  { n: "01", title: "The Psychology of the Fashion Creator", body: "Understand the exact mental trap holding you — and the three hidden desires your audience has that they'll pay to fulfill." },
  ...
  { n: "03", title: "Research & Validation", body: "Copy-paste  prompts that do your entire competitor research, audience pain analysis, and Instagram audit in under 48 hours." },
  { n: "04", title: "Product Creation with AI", body: "The exactprompt that generates your complete digital product — outline, module content, offer name, and sales copy — in one session." },
  ...
  { n: "09", title: "Two Launch Paths", body: "Low-ticket launch and high-ticket launch  — laid out side by side so you pick what matches your offer." },
